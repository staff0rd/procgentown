...
import { MIN_ZOOM, MAX_ZOOM, GRID_OFFSET_X, GRID_OFFSET_Y } from './config'
...
export class CameraManager {
  ...
  private initializeTransform(): void {
    ...
    this.world.position.set(this.screenWidth / 2 + GRID_OFFSET_X, this.screenHeight / 2 + GRID_OFFSET_Y)
  ...
  updateScreenSize(width: number, height: number): void {
    ...
    this.world.position.set(width / 2 + GRID_OFFSET_X, height / 2 + GRID_OFFSET_Y)
  }
}
